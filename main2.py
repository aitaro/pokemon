...
# print(First_HP + First_Attack + First_Defense + First_Sp_Attack + First_Sp_Defense + First_Speed)
# buttle_data['First_all'] = (np.array(First_HP) + np.array(First_Attack) + np.array(First_Defense) + np.array(First_Sp_Attack) + np.array(First_Sp_Defense) + np.array(First_Speed))
